...
/**
 * Simple in-memory rate limiter per IP using a sliding window (timestamps queue). Not suitable for
 * distributed systems — for production use a distributed store (Redis) or API gateway.
 */
